    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-blue-900">Competitive World</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="bg-blue-900 text-white px-8 py-4 rounded-lg text-lg font-medium hover:bg-blue-800 transition-colors duration-200 flex items-center justify-center"
              >
                Start Your Journey
              ...
              <Link
                href="/services"
                className="border-2 border-blue-900 text-blue-900 px-8 py-4 rounded-lg text-lg font-medium hover:bg-blue-900 hover:text-white transition-colors duration-200"
              >
                Our Services
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <Link
                href="/contact"
                className="bg-blue-900 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-800 transition-colors duration-200 inline-flex items-center"
              >
                Book Consultation
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/about"
            className="bg-white text-blue-900 px-8 py-4 rounded-lg text-lg font-medium hover:bg-gray-100 transition-colors duration-200 inline-flex items-center"
          >
            Learn About Us
            <ArrowRightIcon className="ml-2 h-5 w-5" />
          </Link>
